...
.cardone.redmask {
  ...
  background-image: url("charm.png");
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-4">
                    ...
                    <h3 style="color:white; font-weight:bold; text-align:center;">PokaAI</h3>
    ...
    <div class="basic-1 " style="background-color:black">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h3 style="color:#fba0e3">Poka AI make your NFT your personal assistance!  </h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <!-- <div class="cardone redmask"> -->
                      <div>
                    <img src="squritle.png" alt="" width="100%">
...
<!-- 
                ...
                <div class="col-lg-6">
                    <h3 style="color:#fba0e3"> Presale & Holders</h3>
                 
                    <ul>
                         <p style="line-height: 40px; color:white;" ></p> 
                         <p style="line-height: 40px; color:white;" >Holders and Presale </p> 
              ...
              <div class="col-md-6">
                <div class="timeline-box">
                  ...
                  <div class="timeline-text">
                    ...
                    <ul>
                                <li style="color:white;"> Launch the PokaAi Token on the ethereum network </li>
                               ...
                               <li style="color:white;">Launch The custom NFT to holders and presale buyers</li>
            ...
            <div class="row timeline-left">
              ...
              <div class="col-md-6">
                <div class="timeline-box">
                  ...
                  <div class="timeline-text">
                  <h3 style="color:white;">Design Development</h3>

                  <ul>
                        <li style="color:white;">Launch 30 Custom pokaAi NFT to holders 
                       </li>
                 </ul>
                  </div>
              ...
              <div class="col-md-6">
                <div class="timeline-box">
                  ...
                  <div class="timeline-text">
                    ...
                    <ul>
                          <li style="color:white;">Launching a interactive bot what works with your Poka AI NFT</li>
                    </ul>
                    </div>
                </div>
              </div>
            ...
            <!-- <div class="row timeline-left">
              ...
              <div class="col-md-6">
                <div class="timeline-box">
                  ...
                  <ul>
                        <li style="color:white;">Creating a more interactive  </li>
                 </ul>
                  </div>
                  <div class="timeline-icon d-md-block d-none">
                  </div>
    ...
    <div class="slider-1">
        <div class="container">
            <div class="row">
                ...
                <h3 style="text-align:center; color:#fba0e3;">Poka AI Will offer different perks to our</h3>
            ...
            <div class="col-md-12">
                <h2 class="vouch-merchant-customerh2" style="text-align: center; padding-bottom:80px; font-size: 60px; color:black; ">FAQ</h2>
                    ...
                    <div class="question-title">
                        <h3 style="color:white;">What is  Poka AI?</h3>
                        <div class="content-main">
                            <div class="content-inner">
                                <p style="color:black;">
                                PPoka AI a collection of NFT that aims to make your Poka NFT your personal assistance!
                            </p>
                            </div>
